...
void gui_init(dt_lib_module_t *self)
{
  ...
  darktable.lib->proxy.colorpicker.picked_color_rgb_mean = (float *)dt_malloc(sizeof(float) * 3);
  darktable.lib->proxy.colorpicker.picked_color_rgb_min = (float *)dt_malloc(sizeof(float) * 3);
  darktable.lib->proxy.colorpicker.picked_color_rgb_max = (float *)dt_malloc(sizeof(float) * 3);
