  ...
  if((citem = g_list_first(darktable.camctl->cameras)) != NULL)
  {
    ...
    do
    {
      ...
      if(ib)
      {
        ...
        g_object_set_data(G_OBJECT(ib), "dt-help-url", "lighttable_panels.html#import_from_camera");
      }
      if(tb)
      {
        ...
        g_object_set_data(G_OBJECT(tb), "dt-help-url", "lighttable_panels.html#import_from_camera");
      }
...
void gui_init(dt_lib_module_t *self)
{
  ...
  g_object_set_data(G_OBJECT(widget), "dt-help-url", "lighttable_panels.html#import_from_fs");
  ...
  g_object_set_data(G_OBJECT(scan), "dt-help-url", "lighttable_panels.html#import_from_camera");
  d->scan_devices = scan;
