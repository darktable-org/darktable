...
void gui_init(dt_lib_module_t *self)
{
  ...
  g_object_set(G_OBJECT(bt), "tooltip-text", _("duplicate image with pristine history stack"), (char *)NULL);
  ...
  g_object_set(G_OBJECT(bt), "tooltip-text", _("duplicate image with the same history stack"), (char *)NULL);
