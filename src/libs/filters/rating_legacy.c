...
static gboolean _rating_legacy_update(dt_lib_filtering_rule_t *rule)
{
...
static void _rating_legacy_widget_init(dt_lib_filtering_rule_t *rule, const dt_collection_properties_t prop,
