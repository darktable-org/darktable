...
gui_init (dt_lib_module_t *self)
{
  ...
  dt_gui_key_accel_block_on_focus (GTK_WIDGET (d->width), TRUE);
  dt_gui_key_accel_block_on_focus (GTK_WIDGET (d->height), TRUE);
  /*
...
gui_cleanup (dt_lib_module_t *self)
{
  ...
  dt_gui_key_accel_block_on_focus (GTK_WIDGET (d->width), FALSE);
  dt_gui_key_accel_block_on_focus (GTK_WIDGET (d->height), FALSE);
