...
static void
_unit_callback (GtkWidget *combo, gpointer user_data)
{
  dt_lib_module_t *self = (dt_lib_module_t *)user_data;
  dt_lib_print_settings_t *ps = (dt_lib_print_settings_t *)self->data;

  ps->unit = gtk_combo_box_get_active(GTK_COMBO_BOX(combo));
...
gui_init (dt_lib_module_t *self)
{
  ...
  gtk_combo_box_set_active(GTK_COMBO_BOX(comb), d->unit);
