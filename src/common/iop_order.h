...
/** likewise but migration is done to the list of iop order */
int dt_ioppr_migrate_iop_order_from_list(struct dt_develop_t *dev, const int imgid, GList *iop_order_list);
