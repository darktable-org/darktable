...
#define OSD_ELEVATION_ASL "Above sea level"
#define OSD_ELEVATION_BSL "Below sea level"
...
gchar *dt_util_elevation_str(float elevation)
{
  ...
  return g_strdup_printf("%.2f %s %s", elevation, _("m"), c);
}
