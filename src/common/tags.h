...
/** detach all non dt tags from images. \param[in] imgid the image id to detach
 * tags from, if < 0 images to act on are used. */
...
/** get a flat list of tag id (all or only dt tags)*/
