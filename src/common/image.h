...
// TODO: *********************************************************
// this block would need to go as an additional utility layer:
...
// TODO: *********************************************************
// this block should go away altogether:
// FIXME: only used in user flip dreggn. solve via removing f and full buffers
...
// FIXME: try to get rid of this (return buffer objects with w/h anyways)
...
// FIXME: hide these inside the cache:
...
// TODO: *********************************************************
// TODO: 
// TODO: re-implement all these from here on downwards:
/** loads the requested buffer to cache, with read lock set. */
// int dt_image_load(dt_image_t *img, dt_image_buffer_t mip);
#define dt_image_load #error "use dt_mipmap_cache_*get"



#if 0
// now in new mipmap_cache
...
// TODO: get back that debug facility?
#if 0//def _DEBUG
