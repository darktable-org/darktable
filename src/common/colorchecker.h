...
dt_color_checker_t spyder_48 = {  .name = "Datacolor SpyderCheckr 48",
                                  ...
                                  .values = { { "A1", { 61.35,  34.81,  18.38 }, { 0.071, 0.107 } },
                                              ...
                                              { "A3", { 66.82, -25.06,  23.47 }, { 0.071, 0.421 } },
...
dt_color_checker_t spyder_photo = {  .name = "Datacolor SpyderCheckr Photo",
                                  ...
                                  .white = 24,
                                  .black = 29,
                                  .values = { { "A1", { 61.51,  32.31,  14.43 }, { 0.068, 0.146 } },
                                              { "A2", { 74.71,   4.09,  47.99 }, { 0.068, 0.288 } },
                                              { "A3", { 67.34, -25.92,  23.07 }, { 0.068, 0.429 } },
                                              { "A4", { 61.13, -22.28, -21.58 }, { 0.068, 0.571 } },
                                              { "A5", { 59.55,  -4.22, -29.44 }, { 0.068, 0.712 } },
                                              { "A6", { 57.31,  33.77,  -7.32 }, { 0.068, 0.854 } },
                                              { "B1", { 82.02,   2.79,   1.48 }, { 0.168, 0.146 } },
                                              { "B2", { 81.67,  -3.30,   1.34 }, { 0.168, 0.288 } },
                                              { "B3", { 81.53,   1.66,  -3.51 }, { 0.168, 0.429 } },
                                              { "B4", { 29.74,   5.74,   3.05 }, { 0.168, 0.571 } },
                                              { "B5", { 29.69,  -4.49,   2.82 }, { 0.168, 0.712 } },
                                              { "B6", { 29.19,   2.76,  -4.28 }, { 0.168, 0.854 } },
                                              { "C1", { 84.13,   7.62,  11.25 }, { 0.268, 0.146 } },
                                              { "C2", { 74.20,   8.73,  24.67 }, { 0.268, 0.288 } },
                                              { "C3", { 64.18,  13.06,  34.44 }, { 0.268, 0.429 } },
                                              { "C4", { 45.98,  15.67,  23.86 }, { 0.268, 0.571 } },
                                              { "C5", { 25.33,   5.05,   7.14 }, { 0.268, 0.712 } },
                                              { "C6", { 22.04,   2.15,   0.69 }, { 0.268, 0.854 } },
                                              { "D1", { 90.49,   0.26,   1.91 }, { 0.368, 0.146 } },
                                              { "D2", { 86.98,   0.29,   0.56 }, { 0.368, 0.288 } },
                                              { "D3", { 74.28,   0.13,   0.24 }, { 0.368, 0.429 } },
                                              { "D4", { 59.81,   0.57,  -0.65 }, { 0.368, 0.571 } },
                                              { "D5", { 43.95,   1.11,  -0.33 }, { 0.368, 0.712 } },
                                              { "D6", { 29.49,   0.71,   0.07 }, { 0.368, 0.854 } },
                                              { "E1", { 93.14,   0.29,   1.91 }, { 0.632, 0.146 } },
                                              { "E2", { 80.04,   0.30,   0.32 }, { 0.632, 0.288 } },
                                              { "E3", { 66.83,   0.10,   0.03 }, { 0.632, 0.429 } },
                                              { "E4", { 51.50,   0.77,  -0.42 }, { 0.632, 0.571 } },
                                              { "E5", { 36.87,   1.07,  -0.03 }, { 0.632, 0.712 } },
                                              { "E6", { 14.41,   0.45,   1.21 }, { 0.632, 0.854 } },
                                              { "F1", { 49.21, -29.74, -28.15 }, { 0.732, 0.146 } },
                                              { "F2", { 50.22,  48.19, -14.47 }, { 0.732, 0.288 } },
                                              { "F3", { 81.87,   3.40,  81.35 }, { 0.732, 0.429 } },
                                              { "F4", { 43.77,  51.98,  24.51 }, { 0.732, 0.571 } },
                                              { "F5", { 54.47, -35.36,  33.08 }, { 0.732, 0.712 } },
                                              { "F6", { 31.48,  12.72, -42.34 }, { 0.732, 0.854 } },
                                              { "G1", { 61.60,  31.83,  55.23 }, { 0.832, 0.146 } },
                                              { "G2", { 39.85,   6.59, -43.46 }, { 0.832, 0.288 } },
                                              { "G3", { 50.75,  47.22,  13.05 }, { 0.832, 0.429 } },
                                              { "G4", { 32.44,  22.62, -21.32 }, { 0.832, 0.571 } },
                                              { "G5", { 70.22, -21.64,  58.34 }, { 0.832, 0.712 } },
                                              { "G6", { 70.31,  18.33,  64.52 }, { 0.832, 0.854 } },
                                              { "H1", { 70.31, -31.39,  -0.56 }, { 0.932, 0.146 } },
                                              { "H2", { 56.10,   7.42, -25.07 }, { 0.932, 0.288 } },
                                              { "H3", { 42.79, -14.00,  20.46 }, { 0.932, 0.429 } },
                                              { "H4", { 50.34,  -7.34, -23.06 }, { 0.932, 0.571 } },
                                              { "H5", { 65.88,  16.24,  16.82 }, { 0.932, 0.712 } },
                                              { "H6", { 37.51,  14.65,  13.49 }, { 0.932, 0.854 } } } };
