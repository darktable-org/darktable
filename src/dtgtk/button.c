...
void dtgtk_button_set_accel(GtkDarktableButton *button, GtkAccelGroup *accel_group, const gchar *accel_path){gtk_button_set_accel(GTK_BUTTON(button), accel_group,accel_path);};
...
void dtgtk_button_init_accel(GtkAccelGroup *accel_group, const gchar *accel_path){gtk_button_init_accel(accel_group,accel_path);};
