...
void init_global(dt_iop_module_so_t *module)
{
  ...
  dt_iop_monochrome_global_data_t *gd
      = (dt_iop_monochrome_global_data_t *)dt_malloc(sizeof(dt_iop_monochrome_global_data_t));
  module->data = gd;
...
{
  module->params = dt_calloc(1, sizeof(dt_iop_monochrome_params_t));
  module->default_params = dt_calloc(1, sizeof(dt_iop_monochrome_params_t));
...
{
  piece->data = dt_calloc(1, sizeof(dt_iop_monochrome_data_t));
...
{
  self->gui_data = dt_malloc(sizeof(dt_iop_monochrome_gui_data_t));
  dt_iop_monochrome_gui_data_t *g = (dt_iop_monochrome_gui_data_t *)self->gui_data;
