...
static void apply_autotune(dt_iop_module_t *self/*GtkWidget *button, gpointer user_data*/)
{
...
void gui_init(dt_iop_module_t *self)
{
  ...
  dt_bauhaus_widget_set_label(g->auto_button, NULL, _("auto tune source"));
  ...
  // contrast slider
  g->contrast = dt_bauhaus_slider_new_with_range(self, 1., 5., 0.01, p->contrast, 3);
