                                                                                   ...
                                                                                   const float sigma_r)     // range sigma (blur luma values)
{
  ...
  b->buf = dt_malloc_aligned(16, b->size_x * b->size_y * b->size_z * sizeof(dt_iop_colorreconstruct_Lab_t));
  if(!b->buf)
  {
...
static dt_iop_colorreconstruct_bilateral_frozen_t *dt_iop_colorreconstruct_bilateral_freeze(dt_iop_colorreconstruct_bilateral_t *b)
{
  ...
  bf->buf = dt_malloc_aligned(16, b->size_x * b->size_y * b->size_z * sizeof(dt_iop_colorreconstruct_Lab_t));
  if(bf->buf && b->buf)
  {
...
{
  module->params = dt_calloc(1, sizeof(dt_iop_colorreconstruct_params_t));
  module->default_params = dt_calloc(1, sizeof(dt_iop_colorreconstruct_params_t));
