...
void gui_init(dt_iop_module_t *self)
{
  ...
  dt_bauhaus_widget_set_quad_paint(g->shadows_weight, dtgtk_cairo_paint_showmask, CPF_DO_NOT_USE_BORDER, NULL);
  ...
  dt_bauhaus_widget_set_quad_paint(g->mask_grey_fulcrum, dtgtk_cairo_paint_showmask, CPF_DO_NOT_USE_BORDER, NULL);
  ...
  dt_bauhaus_widget_set_quad_paint(g->highlights_weight, dtgtk_cairo_paint_showmask, CPF_DO_NOT_USE_BORDER, NULL);
