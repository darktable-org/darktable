...
{
  module->params = dt_calloc(1, sizeof(dt_iop_colorbalance_params_t));
  module->default_params = dt_calloc(1, sizeof(dt_iop_colorbalance_params_t));
...
{
  piece->data = dt_calloc(1, sizeof(dt_iop_colorbalance_data_t));
