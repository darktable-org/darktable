...
static
void gauss_image_weight(const int size_limit, int width, int height, float *W) {
...
static
void laplace_image(const int size_limit, int width, int height, float *im) {
...
static
void weighted_image(const int size_limit, int width, int height, float *im1, float *im2, float *W) {
