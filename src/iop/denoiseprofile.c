...
void gui_init(dt_iop_module_t *self)
{
  ...
  gtk_notebook_append_page(GTK_NOTEBOOK(g->channel_tabs), GTK_WIDGET(gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 0)),
                           gtk_label_new(C_("color channels", "all")));
  gtk_notebook_append_page(GTK_NOTEBOOK(g->channel_tabs), GTK_WIDGET(gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 0)),
                           gtk_label_new(_("R")));
  gtk_notebook_append_page(GTK_NOTEBOOK(g->channel_tabs), GTK_WIDGET(gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 0)),
                           gtk_label_new(_("G")));
  ...
  dt_bauhaus_widget_set_label(g->profile, NULL, C_("denoise", "profile"));
  ...
  dt_bauhaus_widget_set_label(g->strength, NULL, C_("denoise", "strength"));
