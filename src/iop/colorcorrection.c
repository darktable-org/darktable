...
void init(dt_iop_module_t *module)
{
  ...
  module->priority = 638; // module order created by iop_dependencies.py, do not edit!
...
void gui_init(struct dt_iop_module_t *self)
{
  ...
  dtgtk_slider_set_accel(g->scale5,darktable.control->accels_darkroom,"<Darktable>/darkroom/plugins/color /saturation");
