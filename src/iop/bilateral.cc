...
void gui_init(dt_iop_module_t *self)
{
  ...
  g->red = dt_bauhaus_slider_new_from_params_box(self, "red");
  ...
  g->green = dt_bauhaus_slider_new_from_params_box(self, "green");
  ...
  g->blue = dt_bauhaus_slider_new_from_params_box(self, "blue");
