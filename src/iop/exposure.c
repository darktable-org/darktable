...
{
  piece->data = dt_malloc(sizeof(dt_iop_exposure_data_t));
...
{
  module->params = dt_calloc(1, sizeof(dt_iop_exposure_params_t));
  module->default_params = dt_calloc(1, sizeof(dt_iop_exposure_params_t));
...
void init_global(dt_iop_module_so_t *module)
{
  ...
  dt_iop_exposure_global_data_t *gd
      = (dt_iop_exposure_global_data_t *)dt_malloc(sizeof(dt_iop_exposure_global_data_t));
  module->data = gd;
...
{
  self->gui_data = dt_malloc(sizeof(dt_iop_exposure_gui_data_t));
  dt_iop_exposure_gui_data_t *g = (dt_iop_exposure_gui_data_t *)self->gui_data;
  dt_iop_exposure_params_t *p = (dt_iop_exposure_params_t *)self->params;
