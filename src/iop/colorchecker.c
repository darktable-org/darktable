...
void gui_init(struct dt_iop_module_t *self)
{
  ...
  gtk_widget_set_tooltip_text(g->scale_L, _("scale lightness in Lab space\nlower values darken target color while higher brighten it"));
  ...
  gtk_widget_set_tooltip_text(g->scale_C, _("scale target color saturation\nscales a and b values of target color in Lab simultaneously\nlower values scale towards lower saturation while higher scale towards higher saturation"));
