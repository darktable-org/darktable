...
void gui_init(dt_iop_module_t *self)
{
  ...
  g->red_hue = _setup_hue_slider(self, "red_hue", _("adjustment red to yellow or magenta"));
  g->red_purity = _setup_purity_slider(self, "red_purity", _("red primary purity"));
  g->green_hue = _setup_hue_slider(self, "green_hue", _("adjustment green to cyan or yellow"));
  g->green_purity = _setup_purity_slider(self, "green_purity", _("green primary purity"));
  g->blue_hue = _setup_hue_slider(self, "blue_hue", _("adjustment blue to magenta or cyan"));
