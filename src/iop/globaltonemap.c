...
static inline void process_reinhard(const struct dt_iop_module_t *const self, const dt_dev_pixelpipe_iop_t *const piece,
...
static inline void process_drago(const struct dt_iop_module_t *const self, const dt_dev_pixelpipe_iop_t *const piece,
                                 const void * restrict ivoid, void * restrict ovoid,
                                 const dt_iop_roi_t *const restrict roi_in, const dt_iop_roi_t *const restrict roi_out,
                                 dt_iop_global_tonemap_data_t *data)
{
...
static inline void process_filmic(const struct dt_iop_module_t *const self, const dt_dev_pixelpipe_iop_t *const piece,
                                  const void * restrict ivoid, void * restrict ovoid,
                                  const dt_iop_roi_t *const restrict roi_in, const dt_iop_roi_t *const restrict roi_out,
                                  dt_iop_global_tonemap_data_t *data)
{
