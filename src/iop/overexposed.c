...
void init_global(dt_iop_module_so_t *module)
{
  ...
  dt_iop_overexposed_global_data_t *gd
      = (dt_iop_overexposed_global_data_t *)dt_malloc(sizeof(dt_iop_overexposed_global_data_t));
  module->data = gd;
...
{
  module->params = dt_calloc(1, sizeof(dt_iop_overexposed_t));
  module->default_params = dt_calloc(1, sizeof(dt_iop_overexposed_t));
