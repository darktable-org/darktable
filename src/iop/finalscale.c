...
{
  piece->data = dt_calloc(1, sizeof(dt_iop_finalscale_data_t));
...
{
  self->params = dt_calloc(1, sizeof(dt_iop_finalscale_params_t));
  self->default_params = dt_calloc(1, sizeof(dt_iop_finalscale_params_t));
