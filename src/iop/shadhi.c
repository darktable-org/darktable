...
{
  piece->data = dt_calloc(1, sizeof(dt_iop_shadhi_data_t));
...
{
  module->params = dt_calloc(1, sizeof(dt_iop_shadhi_params_t));
  module->default_params = dt_calloc(1, sizeof(dt_iop_shadhi_params_t));
