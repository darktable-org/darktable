...
static void process_common_setup(const struct dt_iop_module_t *const self, const dt_dev_pixelpipe_iop_t *const piece,
...
static void process_common_cleanup(const struct dt_iop_module_t *const self, const dt_dev_pixelpipe_iop_t *const piece,
                                   const void *const restrict DT_ALIGNED_ARRAY ivoid, void *const restrict DT_ALIGNED_ARRAY ovoid,
                                   const dt_iop_roi_t *const restrict roi_in, const dt_iop_roi_t *const restrict roi_out)
{
