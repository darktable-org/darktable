...
static void
backtransform(float *x, float *o, const float *m, const float *t)
{
  x[0] *= (1.0f + x[1]*0.1f);
  mul_mat_vec_2(m, x, o);
}
...
static void
transform(float *x, float *o, const float *m, const float *t)
{
