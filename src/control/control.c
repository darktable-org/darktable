...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  const float result = darktable.develop->full.zoom_x;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
  return result;
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  darktable.develop->full.zoom_x = value;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  const float result = darktable.develop->full.zoom_y;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
  return result;
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  darktable.develop->full.zoom_y = value;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  const float result = darktable.develop->full.zoom_scale;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
  return result;
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  darktable.develop->full.zoom_scale = value;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  const int result = darktable.develop->full.closeup;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
  return result;
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  darktable.develop->full.closeup = value;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  const dt_dev_zoom_t result = darktable.develop->full.zoom;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
  return result;
}
...
{
  dt_pthread_mutex_lock(&(darktable.control->global_mutex));
  darktable.develop->full.zoom = value;
  dt_pthread_mutex_unlock(&(darktable.control->global_mutex));
}
