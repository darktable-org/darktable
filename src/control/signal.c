...
static dt_signal_description _signal_description[DT_SIGNAL_COUNT] =
{
  ...
  {"dt-image-import",NULL,NULL,G_TYPE_NONE,g_cclosure_marshal_generic,1,uint_arg},               // DT_SIGNAL_IMAGE_IMPORT
  {"dt-image-export-all",NULL,NULL,G_TYPE_NONE,g_cclosure_marshal_VOID__VOID,0,NULL},               // DT_SIGNAL_IMAGE_EXPORT_SELECTION
};
