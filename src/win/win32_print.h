...
typedef struct dt_win32_print_ctx_t 
{
    ...
    HANDLE           hPrinter;
    DEVMODEW        *cached_dm;
    gboolean         settings_opened;
    HWND             hwnd_owner; // optional, for property sheet
    gboolean         is_color_device; // TRUE if printer is color-capable
...
gboolean dt_win_open_printer_settings(dt_win32_print_ctx_t *ctx, HWND hwnd_owner);
