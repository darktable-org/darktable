...
void init(dt_view_t *self)
{
  ...
  luaA_Type my_typeid = dt_lua_module_get_entry_typeid(L,"view",self->module_name);
  lua_pushcfunction(L,latitude_member);
  dt_lua_type_register_typeid(L,my_typeid,"latitude");
  lua_pushcfunction(L,longitude_member);
  dt_lua_type_register_typeid(L,my_typeid,"longitude");
  lua_pushcfunction(L,zoom_member);
  dt_lua_type_register_typeid(L,my_typeid,"zoom");
