                    ...
                    size_t *new_size)
{
  if(old_version == 1 && new_version == 2)
  {
    ...
    dt_imageio_webp_t *n = (dt_imageio_webp_t *)dt_malloc(sizeof(dt_imageio_webp_t));
...
{
  dt_imageio_webp_gui_data_t *gui = (dt_imageio_webp_gui_data_t *)dt_malloc(sizeof(dt_imageio_webp_gui_data_t));
