...
typedef enum dt_disk_onconflict_actions_t
{
  ...
  DT_EXPORT_ONCONFLICT_OVERWRITE = 1, /* overwrite, prompt first */
  DT_EXPORT_ONCONFLICT_SKIP = 2,
  DT_EXPORT_ONCONFLICT_OVERWRITE2 = 3, /* just overwrite */
...
void gui_init(dt_imageio_module_storage_t *self)
{
  ...
  dt_bauhaus_combobox_add(d->onsave_action, _("prompt"));
