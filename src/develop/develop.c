...
void dt_dev_process_preview(dt_develop_t *dev)
{
  ...
  const gboolean err = dt_control_add_job_res(dt_dev_process_preview_job_create(dev),
...
{
  const gboolean err = dt_control_add_job_res(dt_dev_process_preview2_job_create(dev),
