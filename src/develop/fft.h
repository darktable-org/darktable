...
{
  FFT_FILTER_TYPE_HIGHPASS_IDEAL = 1,
  FFT_FILTER_TYPE_LOWPASS_IDEAL = 2,
  FFT_FILTER_TYPE_BANDPASS_IDEAL = 3,
	FFT_FILTER_TYPE_HIGHPASS_BUTTERWORTH = 4,
  FFT_FILTER_TYPE_LOWPASS_BUTTERWORTH = 5,
  FFT_FILTER_TYPE_BANDPASS_BUTTERWORTH = 6,
  FFT_FILTER_TYPE_HIGHPASS_GAUSSIAN = 7,
  FFT_FILTER_TYPE_LOWPASS_GAUSSIAN = 8,
  FFT_FILTER_TYPE_BANDPASS_GAUSSIAN = 9,
  FFT_FILTER_TYPE_LOWPASS_SMOOTH = 10,
  FFT_FILTER_TYPE_BARTLETT = 11
} fft_filter_type;
