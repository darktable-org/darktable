...
{
  IOP_GROUP_NONE = 0,
  IOP_GROUP_TECHNICAL = 1 << 0,
  IOP_GROUP_GRADING = 1 << 1,
  IOP_GROUP_EFFECT = 1 << 2,
  IOP_SPECIAL_GROUP_ACTIVE_PIPE = 1 << 3,
  IOP_SPECIAL_GROUP_USER_DEFINED = 1 << 4
} dt_iop_group_t;
#define IOP_GROUP_ALL (IOP_GROUP_TECHNICAL | IOP_GROUP_GRADING | IOP_GROUP_EFFECT)
