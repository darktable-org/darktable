...
#define DARKTABLE_DATADIR "@RUNTIME_INSTALL_PREFIX@/@CMAKE_INSTALL_DATAROOTDIR@/darktable"
#define DARKTABLE_SHAREDIR "@RUNTIME_INSTALL_PREFIX@/@CMAKE_INSTALL_DATAROOTDIR@"
