...
const dt_gtkentry_completion_spec *dt_gtkentry_get_default_path_compl_list()
{
  static dt_gtkentry_completion_spec default_path_compl_list[]
      = { { "ROLL_NAME", N_("$(ROLL_NAME) - roll of the input image") },
          ...
          { "YEAR", N_("$(YEAR) - year") },
          { "SHORT_YEAR", N_("$(SHORT_YEAR) - year without century") },
          { "MONTH", N_("$(MONTH) - month") },
          { "SHORT_MONTH", N_("$(SHORT_MONTH) - abbreviated month name according to the current locale") },
          { "LONG_MONTH", N_("$(LONG_MONTH) - full month name according to the current locale") },
          { "DAY", N_("$(DAY) - day") },
          { "HOUR", N_("$(HOUR) - hour") },
          { "HOUR_AMPM", N_("$(HOUR_AMPM) - hour, 12-hour clock") },
          { "MINUTE", N_("$(MINUTE) - minute") },
          { "SECOND", N_("$(SECOND) - second") },
          { "MSEC", N_("$(MSEC) - millisecond") },
          { "EXIF_YEAR", N_("$(EXIF_YEAR) - EXIF year") },
          { "EXIF_SHORT_YEAR", N_("$(EXIF_SHORT_YEAR) - EXIF year without century") },
          { "EXIF_MONTH", N_("$(EXIF_MONTH) - EXIF month") },
          { "EXIF_SHORT_MONTH", N_("$(EXIF_SHORT_MONTH) - abbreviated exif month name according to the current locale") },
          { "EXIF_LONG_MONTH", N_("$(EXIF_LONG_MONTH) - full exif month name according to the current locale") },
          { "EXIF_DAY", N_("$(EXIF_DAY) - EXIF day") },
          { "EXIF_HOUR", N_("$(EXIF_HOUR) - EXIF hour") },
          { "EXIF_HOUR_AMPM", N_("$(EXIF_HOUR_AMPM) - EXIF hour, 12-hour clock") },
          ...
          { "DARKTABLE_NAME", N_("$(DARKTABLE_NAME) - darktable name") },
