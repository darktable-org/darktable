...
//   to be the path to the file to load
// otherwise, a shortcuts file will be loaded from the user configuratoin directory,
//   and the contents of 'ext' (if non-NULL) will be appended to the default name.
