                    ...
                    const int only_linear)
{
  ...
  if(only_linear)
  {
    o[0] = fmax(DEMOSAIC_OUTMIN, o[0]);
    o[1] = fmax(DEMOSAIC_OUTMIN, is_xtrans ? o[1] : 0.5f * (o[1] + o[3]));
    o[2] = fmax(DEMOSAIC_OUTMIN, o[2]);
    o[3] = 0.0f;
  }
                ...
                local float *buffer)
{
  ...
  if(x < 2 || x >= width-2 || y < 2 || y >= height-2)
  {
    ...
    write_imagef(out, (int2)(x, y), fmax(DEMOSAIC_OUTMIN, val));
    return;
  }
  ...
  if(gmax == 0.0f)
  {
    ...
    o[2] = buffer[2];
    o[3] = 0.0f;
    write_imagef(out, (int2)(x, y), fmax(DEMOSAIC_OUTMIN, (float4)(o[0], o[1], o[2], o[3])));
    return;
  }
  ...
  o[3] = 0.0f;
  write_imagef(out, (int2)(x, y), fmax(DEMOSAIC_OUTMIN, (float4)(o[0], o[1], o[2], 0.0f)));
}
