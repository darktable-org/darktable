...
FEATURES="AI AVIF CAMERA COLORD GMIC GRAPHICSMAGICK HEIF ICU IMAGEMAGICK JXL KWALLET LIBSECRET LUA MAC_INTEGRATION MAP MCP OPENCL OPENJPEG OPENCV OPENEXR OPENMP PORTMIDI SDL2 UNITY WEBP"
