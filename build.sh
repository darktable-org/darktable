...
cmake -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${BUILD_TYPE} -DINSTALL_IOP_EXPERIMENTAL=ON -DINSTALL_IOP_LEGACY=ON .. && make -j $MAKE_TASKS && sudo make install
