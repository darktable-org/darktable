...
RUN rm -rf /var/lib/apt/lists/* && apt-get update && \
    apt-get install appstream-util clang-3.8 cmake desktop-file-utils g++ gcc gettext git \
...
# pls keep sorted :)
RUN rm -rf /var/lib/apt/lists/* && apt-get update && \
    apt-get install default-jdk-headless default-jre-headless \
    docbook-xsl-saxon fop gnome-doc-utils imagemagick libsaxon-java \
    xsltproc && apt-get clean && rm -rf /var/lib/apt/lists/*
