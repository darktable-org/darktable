We're proud to announce the bug-fix release of darktable, 5.6.2!

The github release is here: [https://github.com/darktable-org/darktable/releases/tag/release-5.6.2](https://github.com/darktable-org/darktable/releases/tag/release-5.6.2).
...
```
$ sha256sum darktable-5.6.2.tar.xz
  darktable-5.6.2.tar.xz

$ sha256sum darktable-5.6.2-x86_64.AppImage
  Darktable-5.6.2-x86_64.AppImage

$ sha256sum darktable-5.6.2-aarch64.AppImage
  Darktable-5.6.2-aarch64.AppImage

$ sha256sum darktable-5.6.2-x86_64.dmg
  darktable-5.6.2-x86_64.dmg

$ sha256sum darktable-5.6.2-arm64.dmg
  darktable-5.6.2-arm64.dmg

$ sha256sum darktable-5.6.2-win64.exe
  darktable-5.6.2-win64.exe

$ sha256sum darktable-5.6.2-woa64.exe
  darktable-5.6.2-woa64.exe
```
...
5.6.2. Please see the user manual for more details of the individual
...
## Camera support, compared to 5.6.1
