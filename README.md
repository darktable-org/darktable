...
* [Download package for Windows](https://github.com/darktable-org/darktable/releases/download/release-5.2.1/darktable-5.2.1-win64.exe)
* [Download disk image for macOS on Intel](https://github.com/darktable-org/darktable/releases/download/release-5.2.1/darktable-5.2.1-x86_64.dmg)
* [Download disk image for macOS on Apple Silicon](https://github.com/darktable-org/darktable/releases/download/release-5.2.1/darktable-5.2.1-arm64.dmg)
* [Download disk image for macOS 13.5 on Apple Silicon](https://github.com/darktable-org/darktable/releases/download/release-5.2.1/darktable-5.2.1-arm64-13.5.dmg)
* [Download AppImage for Linux](https://github.com/darktable-org/darktable/releases/download/release-5.2.1/Darktable-5.2.1-x86_64.AppImage)
