...
B<darktable> is a digital photography workflow application for B<Linux>, B<Mac OS X>
and several other B<Unices> in the lines of B<Adobe Lightroom> and B<Apple Aperture>.

The application is designed to ease editing and consistent processing of large
photo sessions and provides an easy to use digital light-table and a set
...
This will give you a lot of debugging info about the thumbnail cache for light table mode.
...
=item B<darktable-viewer> screensaver version of darktable.
Shows the last active collection in full screen as a slideshow.
Using the slideshow mode of darktable is encouraged.
